...
function MultiAnsQuizPage() {
  ...
  const [choices] = useState(["การกินข้าว", "choice 2", "choice 3", "choice 4", "choice 5"]);
      ...
      {/* Choices */}
        ...
        {choices.map((c, idx) => {
            ...
            <button
                ...
                text-center rounded-2xl font-medium text-lg
                border transition-all duration-200
                ${
                    isSelected
                    ? "bg-green-300 border-green-600 scale-[1.03]"
